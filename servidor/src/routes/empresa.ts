...
class EmpresaRoutes {
    ...
    config(): void {
        ...
        this.router.get('/postulaciones/:id',empresaController.filtrarPostulaciones);
        this.router.get('/notificaciones/:id', empresaController.obtenerNotificaciones); // Ruta para obtener notificaciones
